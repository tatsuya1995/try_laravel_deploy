...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('ドライバー新規登録') }}</div>
                ...
                @endif
                    <form method="POST" action="{{ route('driver.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nameDriver" type="text" class="form-control" name="nameDriver" value="{{ old('nameDriver') }}" required autocomplete="nameDriver" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
