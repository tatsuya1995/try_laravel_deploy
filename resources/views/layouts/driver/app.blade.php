            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="{{'/'}}">サービス説明</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{'/qa'}}">Q＆A</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('driver.show')}}">登録情報</a>
                        </li>
                        @unless (Auth::guard('driver')->check())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('driver.login') }}">ログイン</a>
                            </li>
                            @if (Route::has('driver.register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('driver.register') }}">新規登録</a>
                                </li>
                            @endif
                        @else
