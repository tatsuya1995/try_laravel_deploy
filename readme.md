...
&emsp; | **テーブル名** | **定義** |
&emsp; | ---- | ---- |
&emsp; | owners<br>(オーナー) | オーナーの登録情報 |
&emsp; | drivers<br>(ドライバー) | ドライバーの登録情報 |
&emsp; | owner_schedules<br>(オーナースケジュール) | ドライバーの車両貸出可能な日程 |
&emsp; | chats<br>(チャット) | 会話の内容 |
&emsp; | contracts<br>(コントラクト) | 契約確定後、契約内容を格納|
